# 图 9：Algorithm-component ablation
...
- `Figure_09_algorithm_ablation.png`：从用户提供的 316Manuscript.DOCX 提取并组合的论文结果图；
...
1. Sort every ablation trajectory by generation.
2. Report terminal value and generation reaching 95% of its terminal value.

## 独立运行

```powershell
.venv\Scripts\python implementations/figure_09/analysis.py
```
