...
- `Figure_08_tac_sensitivity.png`：从用户提供的 316Manuscript.DOCX 提取并组合的论文结果图；
...
1. Validate conditional fields for Pareto and HV record types.
2. Summarize objective centroids and HV uncertainty for every TAC scenario.

## 独立运行

```powershell
.venv\Scripts\python implementations/figure_08/analysis.py
```
