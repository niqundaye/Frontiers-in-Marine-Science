# 图 7：Digitalization sensitivity
...
- `Figure_07_digitalization_sensitivity.png`：从用户提供的 316Manuscript.DOCX 提取并组合的论文结果图；
...
1. Fit a first-order sensitivity slope for each algorithm-indicator pair.
2. Report endpoint change across alpha=1.0 to 1.5.

## 独立运行

```powershell
.venv\Scripts\python implementations/figure_07/analysis.py
```
