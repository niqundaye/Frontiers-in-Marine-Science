...
- `Figure_05_pareto_sets.png`：从用户提供的 316Manuscript.DOCX 提取并组合的论文结果图；
...
1. Convert maximization objectives to minimization costs (1-F).
2. Identify non-dominated points within each algorithm.
3. Compute Euclidean distance to the ideal point (1,1,1).

## 独立运行

```powershell
.venv\Scripts\python implementations/figure_05/analysis.py
```
