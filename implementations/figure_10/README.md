...
- `Figure_10_module_ablation.png`：从用户提供的 316Manuscript.DOCX 提取并组合的论文结果图；
...
1. Compute one-SD uncertainty bounds.
2. Compute absolute and relative loss against the Proposed scenario.

## 独立运行

```powershell
.venv\Scripts\python implementations/figure_10/analysis.py
```
