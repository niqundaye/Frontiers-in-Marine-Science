"""Schema, integrity and descriptive audit for article Table 2."""
...
DATA = HERE / "data.csv"
EXPECTED_ROWS = 10
EXPECTED_COLUMNS = ['year', 'total_economic_output', 'capture_value', 'aquaculture_value', 'processing_value', 'circulation_service', 'per_capita_income_rmb', 'export_value_million_usd', 'paper_reported_monetary_unit', 'provenance']
