"""Schema, integrity and descriptive audit for article Table 3."""
...
DATA = HERE / "data.csv"
EXPECTED_ROWS = 10
EXPECTED_COLUMNS = ['year', 'total_production_tonnes', 'marine_aquaculture_tonnes', 'domestic_capture_tonnes', 'distant_water_capture_tonnes', 'processing_enterprises', 'cold_storage_units', 'fleet_power_kw', 'provenance']
