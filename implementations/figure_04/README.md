...
- `Figure_04_kpi_radar.png`：从用户提供的 316Manuscript.DOCX 提取并组合的论文结果图；
...
1. Verify one value per algorithm-indicator cell.
2. Compute mean, minimum and maximum objective score per algorithm.

## 独立运行

```powershell
.venv\Scripts\python implementations/figure_04/analysis.py
```
