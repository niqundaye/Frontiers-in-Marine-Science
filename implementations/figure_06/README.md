...
- `Figure_06_parameter_sensitivity.png`：从用户提供的 316Manuscript.DOCX 提取并组合的论文结果图；
...
1. Compute lower and upper one-SD bands.
2. Rank settings by HV within each parameter and identify the optimum.

## 独立运行

```powershell
.venv\Scripts\python implementations/figure_06/analysis.py
```
